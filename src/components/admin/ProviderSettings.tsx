...
import { Save, RefreshCw, CheckCircle2, XCircle, Wifi, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-card border border-border rounded-2xl p-5 space-y-4">
        ...
        <ProviderField label="Webhook URL" value={cfg.webhookUrl} onChange={f('webhookUrl')} placeholder="https://yourdomain.com/webhook/digiflazz" />
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-card border border-border rounded-2xl p-5 space-y-4">
        ...
        <ProviderField label="Webhook URL" value={cfg.webhookUrl} onChange={f('webhookUrl')} placeholder="https://yourdomain.com/webhook/vip" />
